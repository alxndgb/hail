...
object VEP {
  ...
  val vepSignature = TStruct(
    ...
    "colocated_variants" -> TArray(TStruct(
      ...
      "eur_allele" -> TString,
      "eur_maf" -> TDouble,
      "gnomad_adj_allele" -> TString,
      "gnomad_adj_maf" -> TDouble,
      "gnomad_allele" -> TString,
      "gnomad_afr_allele" -> TString,
      "gnomad_afr_maf" -> TDouble,
      "gnomad_amr_allele" -> TString,
      "gnomad_amr_maf" -> TDouble,
      "gnomad_asj_allele" -> TString,
      "gnomad_asj_maf" -> TDouble,
      "gnomad_eas_allele" -> TString,
      "gnomad_eas_maf" -> TDouble,
      "gnomad_fin_allele" -> TString,
      "gnomad_fin_maf" -> TDouble,
      "gnomad_maf" -> TDouble,
      "gnomad_nfe_allele" -> TString,
      "gnomad_nfe_maf" -> TDouble,
      "gnomad_oth_allele" -> TString,
      "gnomad_oth_maf" -> TDouble,
      "gnomad_sas_allele" -> TString,
      "gnomad_sas_maf" -> TDouble,
      "id" -> TString,
